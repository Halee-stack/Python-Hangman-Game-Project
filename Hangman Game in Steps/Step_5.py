...
while not game_over:
    ...
    # Step-6: - Update the code below to tell the user how many lives they have left.
    ...
    if guess not in chosen_word:
        ...
        if lives == 0:
            ...
            # Step 7: - Update the print statement below to give the user the correct word they were trying to guess.
    ...
    # Step-2: - Update the code below to use the stages List from the file hangman_art.py
    print(stages[lives])
